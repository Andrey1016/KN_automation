...
class CreateAllItems(BasePage):
    ...
    def try_close_success_window(self):
        try:
            self.element_is_clickable(self.locators.SUCCESS_WINDOW_CLOSE).click()
        except NoSuchElementException:
            pass
    ...
    def fill_date_filed(self):
        try:
            ...
            for date_fields in date_fields:
                date_fields.send_keys(self.current_timestamp())
        except NoSuchElementException:
            pass

    def fill_due_date_filed(self):
        try:
            due_date_fields = self.elements_are_present2(self.locators.DUE_DATE_FIELD)
            for due_date_field in due_date_fields:
                due_date_field.send_keys("2024, Dec 31 11:59 PM")
        except NoSuchElementException:
            pass

    def fill_review_by_date_filed(self):
        try:
            review_by_date_fields = self.elements_are_present2(self.locators.REVIEW_BY_DATE_FIELD)
            for review_by_date_field in review_by_date_fields:
                review_by_date_field.send_keys("2024, Dec 31 11:59 PM")
        except NoSuchElementException:
            pass
    ...
    def fill_responsible(self):
        try:
            while True:
                dropdowns = self.elements_are_present2(self.locators.RESPONSIBLE)
                if not dropdowns:
                    break
                ...
                first_option = self.element_is_clickable(self.locators.API_AUTOTEST_USER_RESPONSIBLE)
                if first_option:
                    first_option.click()
                    time.sleep(1.5)
        except NoSuchElementException:
    ...
    def create_item_active_status(self):
        ...
        for item in items:
            ...
            self.fill_due_date_filed()

            self.fill_responsible()
    ...
    #     =======================================All Items in DEFERRED status=======================================

    def create_item_deferred_status(self):
        self.element_is_visible(self.header_locators.HEADER_CREATE_BTN).click()
        ...
        for item in items:
            ...
            self.element_is_clickable(self.locators.DEFERRED_STATUS_BTN).click()

            self.fill_review_by_date_filed()
...
class Cards(BasePage):
    ...
    def add_item_list_card(self, report_type_locator, report_name):
        ...
        self.element_is_visible(self.cards_locators.REPORT_CARD_ADD).click()
...
#
#
#     def create_board_with_all_cards(self):
#         self.element_is_visible(self.header_locators.HEADER_BOARDS).click()
#         self.element_is_visible(self.create_delete_board_locators.CREATE_BOARD).click()
#         self.element_is_visible(self.create_delete_board_locators.BOARD_TITLE).send_keys(
#             "Board With ALL cards (except reports)")
#         self.element_is_visible(self.create_delete_board_locators.BOARD_CREATE_BTN).click()
#         time.sleep(1)
#
#     def navigate_to_board_with_all_cards(self):
#         try:
#             self.element_is_visible(self.header_locators.HEADER_BOARDS).click()
#             self.element_is_visible(self.create_delete_board_locators.BOARD_ALL_CARDS).click()
#         except NoSuchElementException:
#             logging.error("board is not accessible.")
#             raise
#
#     def add_item_list_card(self):
#         self.element_is_visible(self.header_locators.BOARDS_ADD_DROPDOWN).click()
#         self.element_is_visible(self.ADD).click()
